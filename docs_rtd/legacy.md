...
The original symusic documentation lives in an mdBook under `docs/src`. It still covers important
concepts, but several APIs mentioned there have been renamed or removed.

- Live site: <https://yikai-liao.github.io/symusic/>
- Sources: `docs/src/*.md`
