...
MIDI_PATHS_ONE_TRACK = sorted((HERE / "testcases" / "MIDIs_one_track").rglob("*.mid"))
MIDI_PATHS_MULTITRACK = sorted((HERE / "testcases" / "MIDIs_multitrack").rglob("*.mid"))
MIDI_PATHS_CORRUPTED = sorted((HERE / "testcases" / "MIDIs_corrupted").rglob("*.mid"))
